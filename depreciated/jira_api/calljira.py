# THIS SCRIPT IS NO LONGER USED AS WE DON'T HAVE ACCESS TO JIRA TOKENS ANYMORE
# This script is used to get the pull request data from the github api and store it in a csv file
...
if __name__ == "__main__":
    main() 
    # -- DO NOT RUN ON NON-SAP ENVIRONMENT
